...
+Main. Проверяет, существует ли файл с расширением .csv. Если нет, то запускает модуль создания файла с шапкой таблицы. После этого вызываетя модуль записи, который, в свою очередь, забирает информацию из UI.